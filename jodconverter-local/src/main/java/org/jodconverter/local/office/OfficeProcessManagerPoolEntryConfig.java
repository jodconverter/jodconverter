...
/**
 * This class holds the configuration of an {@link
 * org.jodconverter.local.office.OfficeProcessManagerPoolEntry} when an office instance is required
 * to execute a conversion.
 *
 * @see org.jodconverter.local.office.OfficeProcessManagerConfig
 * @see org.jodconverter.local.office.OfficeProcessManagerPoolEntry
 */
