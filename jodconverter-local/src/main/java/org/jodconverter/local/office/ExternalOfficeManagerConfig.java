...
import org.jodconverter.core.office.OfficeManagerConfig;
...
class ExternalOfficeManagerConfig implements OfficeManagerConfig {
   ...
   *     connection will only be attempted the first time an {@link
   *     org.jodconverter.core.task.OfficeTask} is executed.
