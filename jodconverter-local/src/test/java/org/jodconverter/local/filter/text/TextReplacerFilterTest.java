...
class TextReplacerFilterTest {

  @Nested
  class New {

    @Test
    void withArgumentsSizeNotEqual_ShouldThrowIllegalArgumentException() {
    ...
    @Test
    void withEmptyReplacementList_ShouldThrowsIllegalArgumentException() {
    ...
    @Test
    void withEmptySearchList_ShouldThrowIllegalArgumentException() {
  ...
  class DoFilter {
    ...
    void withUnsupportedDocument_ShouldCallNextFilter(final UnoRuntime unoRuntime)
      ...
      final TextReplacerFilter filter =
          new TextReplacerFilter(
              new String[] {"SEARCH_STRING"}, new String[] {"REPLACEMENT_STRING"});
