...
/** Configuration class for JODConverter Online. */
@ConfigurationProperties("jodconverter.online")
public class JodConverterOnlineProperties {

  /** Enable JODConverter Online. */
