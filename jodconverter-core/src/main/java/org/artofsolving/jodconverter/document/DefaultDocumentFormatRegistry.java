...
public class DefaultDocumentFormatRegistry extends SimpleDocumentFormatRegistry {
    ...
    public DefaultDocumentFormatRegistry() {
        ...
        DocumentFormat doc = new DocumentFormat("Microsoft Word 97-2003", "doc", "application/msword");
        ...
        DocumentFormat docx = new DocumentFormat("Microsoft Word 2007-2013 XML", "docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document");
        ...
        DocumentFormat xls = new DocumentFormat("Microsoft Excel 97-2003", "xls", "application/vnd.ms-excel");
        ...
        DocumentFormat xlsx = new DocumentFormat("Microsoft Excel 2007-2013 XML", "xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
        ...
        DocumentFormat ppt = new DocumentFormat("Microsoft PowerPoint 97-2003", "ppt", "application/vnd.ms-powerpoint");
        ...
        DocumentFormat pptx = new DocumentFormat("Microsoft PowerPoint 2007-2013 XML", "pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation");
