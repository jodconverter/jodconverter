...
class ManagedOfficeProcessSettings {
     ...
     */
    public ManagedOfficeProcessSettings(UnoUrl unoUrl, File officeHome, File workingDir, ProcessManager processManager) {
