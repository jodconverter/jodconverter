 ...
 * OfficeManagerPool} that does not depend on an office installation. It will simply submit tasks
 * with a null office context and wait until the task is done or a configured task execution timeout
 * is reached.
 *
