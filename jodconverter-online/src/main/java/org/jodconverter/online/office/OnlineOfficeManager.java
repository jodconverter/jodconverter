...
public final class OnlineOfficeManager extends AbstractOfficeManagerPool {
  ...
  /**
   * Creates a new {@link org.jodconverter.online.office.OnlineOfficeManager} with default
   * configuration.
   *
   * @param urlConnection The URL to the LibreOfficeOnline server.
   * @return A {@link org.jodconverter.online.office.OnlineOfficeManager} with default
   *     configuration.
   */
  ...
  /**
   * Creates a new {@link org.jodconverter.online.office.OnlineOfficeManager} with default
   * configuration. The created manager will then be the unique instance of the {@link
  ...
  /**
   * A builder for constructing a {@link org.jodconverter.online.office.OnlineOfficeManager}.
   *
