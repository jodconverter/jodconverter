...
import org.jodconverter.core.office.OfficeManagerPoolConfig;

/**
 * This class provides the configuration of an {@link
 * org.jodconverter.core.office.AbstractOfficeManagerPool} when no office instance are required to
 * execute conversion.
 *
 * @see org.jodconverter.core.office.AbstractOfficeManagerPool
 */
class OnlineOfficeManagerPoolConfig extends OnlineOfficeManagerPoolEntryConfig
   ...
   */
  public OnlineOfficeManagerPoolConfig(final File workingDir) {
    super();
